...
class BusquedaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Detectar modo
        val modo = intent.getStringExtra("MODO") ?: "DETALLADO"
        
        // Configurar toolbar según modo
        supportActionBar?.apply {
            title = if (modo == "LISTA") "Hacer Lista de Compras" else "Buscar Productos"
    ...
    private fun realizarBusqueda() {
        ...
        // Navegar a ProductListActivity (vista detallada)
